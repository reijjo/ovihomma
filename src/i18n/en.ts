  ...
  tuotteet: {
    ...
    paloOvet: {
      ...
      info: {
        ...
        moreInfo: "Fire doors have been tested and awarded the appropriate certifications. The doors are made of <b>strong steel</b>, while the shutters use specially manufactured fibreglass and steel wire fabric. The door slats are galvanised steel.",
        moreInfo2: "The fire-door structure is designed to ensure the <b>fastest possible evacuation</b> from a fire area. Special attention has therefore been paid to opening and closing speed. The doors include fire detectors and alarms. High-quality operators and monitoring systems ensure simple and safe use even in the event of a fire or power cut."
      },
      sertifikaatit: {
        title: "Fire safety certificates",
        items: {
          metalli: "Metal doors have EI 15, EI 30, EI 45, EI 60, EI 90 and EI 120 certificates.",
          rulla: "Roller doors meet the EI 60 and EI 120 fire safety requirements.",
