    ...
    nostoOvet: {
      ...
      turvallisuus: {
        ...
        items: {
          ...
          item2: "<b>Lukko</b> – Ovi voidaan avata sisältä tai ulkoa. Suositellaan käytettävän, jos ovessa ei ole lisäsisäänpääsyä.",
          item3: "<b>Murtosuoja</b> – Jos ovessa on sähköinen käyttölaite, ovea ei voida ulkoapäin käsin avata.",
          item4: "<b>Estesuoja</b> – Jos oven sulkeutuessa jää oven alle jokin este (ihminen, eläin, auto), oven liike pysähtyy ja se liukuu taas ylöspäin.",
          item5: "<b>Valokennot</b> – Ovi avautuu automaattisesti, kun valokennojen vaikutusalueeseen ilmestyy jokin este.",
          item6: "<b>Sormisuoja</b> – Ovilamellien rakenne poissulkee sormien juuttumisen lamellien väliin."
        }
      },
      laatu: {
